  ...
  return (
    <div>
      <button
        ...
        onClick={onResend}
        disabled={loading}
        className="inline-flex min-h-9 w-full items-center justify-center rounded-md border border-[#003F73]/20 bg-white px-3 py-2 text-xs font-semibold text-[#003F73] shadow-sm transition-colors hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
      >
